...
const FeaturedProject = ({ title, description, languages, imageLink, githubLink, projectLink }: FeaturedProjectProps) => {
    return (
        <div className="bg-[#464866] border border-[#5a5d7a] border-l-4 border-l-[#2E9CCA] rounded-md flex lg:flex-row flex-col gap-5 px-5 pb-4 relative mb-24 transition hover:-translate-y-2 hover:shadow-[0_8px_30px_rgba(46,156,202,0.15)]">
