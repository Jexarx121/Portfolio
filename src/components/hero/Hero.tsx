const Hero = () => {
  return (
    <div className="lg:w-[60%] md:w-[80%] sm:w-[90%] w-[100%] m-auto min-h-screen flex flex-col mt-48 sm:p-0 px-8">
      ...
      <p className="xl:w-[50%] lg:w-[60%] md:w-[75%] sm:text-[20px] text-[18px] font-medium lg:my-6 md:my-5 my-4">I&#39;m a developer from Cork, Ireland. I aspire to tackle diverse challenges and creates impactful solutions through extraordinary applications.</p>
