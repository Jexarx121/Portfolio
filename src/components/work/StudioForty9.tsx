const StudioForty9 = () => {
  return (
    <div className="lg:w-[90%] w-[100%]">
      <h1 className="text-white lg:text-4xl sm:text-3xl text-2xl font-bold">Junior QA Engineer</h1>
      ...
      <ol className="text-[#aaabb8] list-disc list-inside lg:text-[20px] sm:text-[18px] text-[16px] marker:text-[#2E9CCA]">
        ...
        <li className="py-1"><b>Technical Skills</b>: Cypress, JavaScript, React Testing Library, Jenkins, Jira, Git</li>
        <li className="py-1"><b>Soft Skills</b>: Teamwork, QA Thinking, Agile, Communication, Time Management, Presentation</li>
      </ol>
    </div>
  );
}

export default StudioForty9;