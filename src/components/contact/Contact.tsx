...
const Contact = () => {
  return (
    <div className="lg:w-[80%] sm:w-[90%] w-[100%] m-auto sm:mb-60 mb-48 sm:p-0 px-8" id="contact">
      ...
      <button className="text-[20px] text-white border-[#2E9CCA] border-2 px-5 py-2 rounded-md hover:bg-[#2E9CCA] hover:font-bold transition duration-300">Message</button>
    </div>
  )
}
